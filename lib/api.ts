...
export const authApi = {
  login: async (credentials: LoginCredentials): Promise<ApiResponse<AuthTokens & { user: User }>> => {
    const response = await apiRequest<ApiResponse<AuthTokens & { user: User }>>("/auth/login", {
      method: "POST",
      body: JSON.stringify(credentials),
    })
    setTokens({ access_token: response.data.access_token, refresh_token: response.data.refresh_token })
    return response
  },
...
export const employeesApi = {
  ...
  update: async (id: number, data: UpdateEmployeeData): Promise<ApiResponse<Employee>> => {
    return apiRequest<ApiResponse<Employee>>(`/employees/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
...
export const departmentsApi = {
  ...
  update: async (id: number, data: UpdateDepartmentData): Promise<ApiResponse<Department>> => {
    return apiRequest<ApiResponse<Department>>(`/departments/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
...
export const positionsApi = {
  ...
  update: async (id: number, data: UpdatePositionData): Promise<ApiResponse<Position>> => {
    return apiRequest<ApiResponse<Position>>(`/positions/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
...
export const vacationsApi = {
  ...
  update: async (id: number, data: UpdateVacationData): Promise<ApiResponse<Vacation>> => {
    return apiRequest<ApiResponse<Vacation>>(`/vacations/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
...
export const requestsApi = {
  ...
  update: async (id: number, data: UpdateRequestData): Promise<ApiResponse<HRRequest>> => {
    return apiRequest<ApiResponse<HRRequest>>(`/requests/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
...
export const usersApi = {
  ...
  update: async (id: number, data: UpdateUserData): Promise<ApiResponse<SystemUser>> => {
    return apiRequest<ApiResponse<SystemUser>>(`/users/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    })
